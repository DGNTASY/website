...
export default function BetInfo() {
	...
	if (!userStatus?.has_betted) {
		return (
			<div className="flex flex-col items-center justify-center gap-5 text-center font-xl font-semibold">
				<h2>
					You haven't betted yet for this gameweek,
					<br />
					once ready hit the bet button!
				</h2>
	...
	return (
		<>
			<div className="flex items-center justify-center gap-3 flex-col font-semibold text-xl">
				...
				<p>
					After the game week took place, press the Update or Send
					Score button,{' '}
